...
This procedure is used to load data from the source CSV files into the
bronze tables. Before loading the new data, it removes the existing data
from the tables to avoid duplicates.

The data is imported using the BULK INSERT command.
